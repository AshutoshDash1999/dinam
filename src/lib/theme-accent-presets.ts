...
export const ACCENT_PRESETS: Record<Exclude<AccentId, "neutral">, AccentPreset> =
    {
        blue,
        green,
        orange,
...
/** Every custom property set by non-neutral accent presets (for clearing inline overrides). */
export const ACCENT_CSS_VARS: string[] = Object.keys(blue.light)

export function mergeAccentVariables(
    preset: AccentPreset,
